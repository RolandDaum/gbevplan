...
async function getVplanURL(attemps, vplanURLList) {
    if (vplanURLList == null) {
        vplanURLList = [];
    }
    ...
    console.log([process.env.apiUSERNAME, process.env.apiPASSWORD])
    ...
    for (let i = 0; i < elements.length; i++) {
        ...
        // console.log(vplanURLList);
    }

    driver.quit();

    if (vplanURLList.length <= 0 && attemps <= 10) {
